...
export default async function Home(props: { searchParams?: Promise<SP> | SP }) {
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Hero Section */}
      <section className="relative w-full border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 py-24 md:py-32">
      ...
      <section className="container mx-auto px-4 md:px-6 py-16">
        {posts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
             ...
             <h3 className="text-lg font-medium text-neutral-900 dark:text-white">No hay artículos aún</h3>
             <p className="text-neutral-500 dark:text-neutral-400 max-w-sm mt-2">
               Estamos trabajando en nuevo contenido. Vuelve pronto para leer las últimas novedades.
             </p>
          </div>
        ) : (
        ...
        <div className="mt-16 flex justify-center gap-4">
          ...
          {/* Very simple check for next page availability */}
